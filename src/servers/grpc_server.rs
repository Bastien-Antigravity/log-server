...
pub const LOG_SERVICE_DESCRIPTOR_SET: &[u8] = include_bytes!(concat!(env!("OUT_DIR"), "/log_service_descriptor.bin"));
...
impl GrpcServer {
    ...
    pub async fn run(
        ...
        server.add_service(LogServiceServer::new(service)).start().await?;
